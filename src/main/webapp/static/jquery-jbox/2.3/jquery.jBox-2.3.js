...
(function (a) {
	a.jBox = function (b, c) {
		...
		j.push('<a class="jbox-close" title="' + a.jBox.languageDefaults.close + '" onmouseover="$(this).addClass(\'jbox-close-hover\');" onmouseout="$(this).removeClass(\'jbox-close-hover\');" style="position:absolute; display:block; cursor:pointer; right:' + (0x6 + c.border) + 'px; width:15px; height:15px;' + (c.showClose ? '' : 'display:none;') + '"></a>');
		if (g) {
	...
	a.jBox.prompt = function (b, c, d, e) {
		...
		h.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute;left:' + (0xa + e.border) + 'px; width:32px; height:32px;"></span>');
		h.push(e.content);
		h.push('</div>');
		e.content = h.join('');
		a.jBox(e.content, e)
	...
	a.jBox.tip = function (b, c, d) {
		...
		e.push('<span class="jbox-icon jbox-icon-' + d.icon + '" style="position:absolute;left:' + (0x4 + d.border) + 'px; width:32px; height:32px;"></span>');
		e.push(d.content);
		e.push('</div>');
		d.content = e.join('');
	...
	a.jBox.messager = function (b, c, d, e) {
		...
		i.push('<span class="jbox-icon jbox-icon-' + e.icon + '" style="position:absolute;left:' + (0xa + e.border) + 'px; width:32px; height:32px;"></span>');
		i.push(e.content);
		i.push('</div>');
		e.content = i.join('');
		a.jBox(e.content, e)
